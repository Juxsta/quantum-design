...
Welcome to ``quantum-design`` contributor's guide.
...
If you experience bugs or general issues with ``quantum-design``, please have a look
...
You can help improve ``quantum-design`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``quantum-design`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``quantum-design``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/quantum-design.git
    cd quantum-design
...
#. Install |pre-commit|_::
   ...
   ``quantum-design`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/quantum-design
.. _issue tracker: https://github.com/<USERNAME>/quantum-design/issues
.. <-- end -->
